...
public class SqlInjectionLoginLabController {
    ...
    public String taskPage(Model model) {
        ...
        return "lab/sqli-login-oracle";
    }

    @GetMapping("/labs/" + SqlInjectionLoginLab.LAB_ID)
    public String legacyLabRoute() {
        return "redirect:" + labDefinition.getEntryPath();
    }

    @GetMapping("/tasks/" + SqlInjectionLoginLab.LAB_ID)
    public String legacyTasksRoute() {
        return "redirect:" + labDefinition.getEntryPath();
    }

    @PostMapping("/web/labs/" + SqlInjectionLoginLab.LAB_ID + "/tasks/{taskId}/hints/{hintId}")
    ...
    @PostMapping("/web/labs/" + SqlInjectionLoginLab.LAB_ID + "/submit-flag")
