...
public class FileAttachmentTraversalLabController {
    ...
    public String taskPage(Model model) {
        ...
        return "lab/file-attachment-path-traversal";
    }

    @GetMapping("/labs/" + FileAttachmentTraversalLab.LAB_ID)
    public String legacyLabRoute() {
        return "redirect:" + labDefinition.getEntryPath();
    }

    @GetMapping("/tasks/" + FileAttachmentTraversalLab.LAB_ID)
    public String legacyTasksRoute() {
        return "redirect:" + labDefinition.getEntryPath();
    }

    @PostMapping("/web/labs/" + FileAttachmentTraversalLab.LAB_ID + "/tasks/{taskId}/hints/{hintId}")
    ...
    @PostMapping("/web/labs/" + FileAttachmentTraversalLab.LAB_ID + "/submit-flag")
