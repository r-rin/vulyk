...
public class SqlInjectionBooleanMarketplaceLabController {

    private final SqlInjectionBooleanMarketplaceLab labDefinition;
    private final LabProgressService labProgressService;

    @GetMapping("/web/labs/" + SqlInjectionBooleanMarketplaceLab.LAB_ID)
    public String taskPage(Model model) {
        ...
        return "lab/sqli-marketplace-boolean";
    }

    @GetMapping("/labs/" + SqlInjectionBooleanMarketplaceLab.LAB_ID)
    public String legacyLabRoute() {
        return "redirect:" + labDefinition.getEntryPath();
    }

    @GetMapping("/tasks/" + SqlInjectionBooleanMarketplaceLab.LAB_ID)
    public String legacyTasksRoute() {
        return "redirect:" + labDefinition.getEntryPath();
    }

    @PostMapping("/web/labs/" + SqlInjectionBooleanMarketplaceLab.LAB_ID + "/tasks/{taskId}/hints/{hintId}")
    ...
    @PostMapping("/web/labs/" + SqlInjectionBooleanMarketplaceLab.LAB_ID + "/submit-flag")
