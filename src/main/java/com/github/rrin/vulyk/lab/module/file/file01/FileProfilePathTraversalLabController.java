...
public class FileProfilePathTraversalLabController {
    ...
    public String taskPage(Model model) {
        ...
        return "lab/file-profile-path-traversal";
    }

    @GetMapping("/labs/" + FileProfilePathTraversalLab.LAB_ID)
    public String legacyLabRoute() {
        return "redirect:" + labDefinition.getEntryPath();
    }

    @GetMapping("/tasks/" + FileProfilePathTraversalLab.LAB_ID)
    public String legacyTasksRoute() {
        return "redirect:" + labDefinition.getEntryPath();
    }

    @PostMapping("/web/labs/" + FileProfilePathTraversalLab.LAB_ID + "/tasks/{taskId}/hints/{hintId}")
    ...
    @PostMapping("/web/labs/" + FileProfilePathTraversalLab.LAB_ID + "/submit-flag")
