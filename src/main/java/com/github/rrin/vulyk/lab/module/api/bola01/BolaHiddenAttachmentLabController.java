...
public class BolaHiddenAttachmentLabController {
    ...
    public String taskPage(Model model) {
        ...
        return "lab/bola-hidden-attachment";
    }

    @GetMapping("/labs/" + BolaHiddenAttachmentLab.LAB_ID)
    public String legacyLabRoute() {
        return "redirect:" + labDefinition.getEntryPath();
    }

    @GetMapping("/tasks/" + BolaHiddenAttachmentLab.LAB_ID)
    public String legacyTasksRoute() {
        return "redirect:" + labDefinition.getEntryPath();
    }

    @PostMapping("/web/labs/" + BolaHiddenAttachmentLab.LAB_ID + "/tasks/{taskId}/hints/{hintId}")
    ...
    @PostMapping("/web/labs/" + BolaHiddenAttachmentLab.LAB_ID + "/submit-flag")
