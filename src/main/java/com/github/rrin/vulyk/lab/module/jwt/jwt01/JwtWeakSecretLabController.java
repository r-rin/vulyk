...
public class JwtWeakSecretLabController {
    ...
    public String taskPage(Model model) {
        ...
        return "lab/jwt-weak-secret";
    }

    @GetMapping("/labs/" + JwtWeakSecretLab.LAB_ID)
    public String legacyLabRoute() {
        return "redirect:" + labDefinition.getEntryPath();
    }

    @GetMapping("/tasks/" + JwtWeakSecretLab.LAB_ID)
    public String legacyTasksRoute() {
        return "redirect:" + labDefinition.getEntryPath();
    }

    @PostMapping("/web/labs/" + JwtWeakSecretLab.LAB_ID + "/tasks/{taskId}/hints/{hintId}")
